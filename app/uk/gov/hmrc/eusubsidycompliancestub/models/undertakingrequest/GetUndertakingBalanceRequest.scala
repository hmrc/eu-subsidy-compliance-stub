...
case class GetUndertakingBalanceRequest(
  ...
  undertakingIndentifier: Option[UndertakingRef] = None
)

object GetUndertakingBalanceRequest {
  implicit val format: Format[GetUndertakingBalanceRequest] = Json.format[GetUndertakingBalanceRequest]
}
